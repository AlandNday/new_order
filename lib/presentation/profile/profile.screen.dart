...
class ProfileScreen extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<ProfileController>() == null) {
      // Check if controller is already found
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _ProfileOptionTile(
              icon: Icons.history, // History icon for purchase history
              title:
                  'Riwayat Pembelian', // "Riwayat Pembelian" (Purchase History)
              onTap: () {
                Get.toNamed(Routes.TRANSACTIONHISTORY);
                // You would navigate to the purchase history screen here
                // Get.toNamed('/purchase_history');
              },
            ),
